...
export const createProduct = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.post(`/api/products`, {}, config) //{} it denotes we make post request without send any props
...
export const updateProduct = product => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.put(
      ...
      product,
      config
    ) //{} it denotes we make post request without send any props
