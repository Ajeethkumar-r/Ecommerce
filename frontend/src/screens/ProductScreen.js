            ...
            <Card>
              <ListGroup variant='flush'>
                ...
                {product.countInStock > 0 && (
                  ...
                  </ListGroupItem> //take product array and pick countInStock then map through the product array using it keys and set qty using useState with option and qty ? as query string
                )}
                <Button
